<header class="flex py-6 px-10 item-center fixed top-0 w-full justify-between text-white z-30 ">
    <div class="flex flex-grow items-center w-1/4">
    ...
    <nav class="flex justify-center items-center w-2/4">
        <ul class="flex text-lg justify-center items-center">
    ...
    <nav class="flex flex-grow justify-end w-1/4">
        <ul class="flex">
